...
//		System.out.println("cba".hashCode());
		Random r = new Random();
		DivisionHash<Object> h = new DivisionHash<Object>(19); // original no. of bucket = 8
		for (int i=0; i < 1000; i = i + 13) { // original +16
			h.add(new MyInteger(i)); // add some integers to bucket 
		}
		h.dumpBuckets(); // print out buckets
	}
