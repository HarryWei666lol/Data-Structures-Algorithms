...
public class BadHash<T> implements Set<T> {
	...
	public BadHash() {
		this.buckets = (LinkedList<T>[]) new LinkedList[numBuckets]; // the list contains buckets which are of type Array
	...
	public static void main(String[] args) {
		...
		for (int i=0; i < 1000; i=i+16) {
			bh.add(i); // all goes to bucket 0
//			bh.add(r.nextInt()); // add random numbers
		}
		bh.dumpBuckets();
	}
